...
class Movies: NSObject {
    ...
    /*
     //
     // A ordem da tupla é: NOME DO FILME, DESCRIÇÃO DO FILME, DATA DE LANÇAMENTO, NOME DA IMAGEM (String, String, String, String).
     //
     */
    
    static let movies: [(String, String, String, String)] = [
